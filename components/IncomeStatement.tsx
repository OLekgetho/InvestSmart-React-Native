...
export default function IncomeStatement({ symbol }: IncomeStatementProps) {
    const [data, setData] = useState<IncomeStatementResponse>({});
    ...
    useEffect(() => {
        fetch(
            `http://192.168.1.105:8085/api/stock/info/profile/income/${symbol}`
        )
            .then((res) => res.json())
    ...
    return (
        <View>
            <Text className="text-white text-2xl font-light border-b">Income Statement</Text>
